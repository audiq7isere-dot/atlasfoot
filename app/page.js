...
<section className="homeVideos"><div className="sectionTitle"><div><span className="eyebrow">🎥 ATLASFOOT TV · YOUTUBE OFFICIEL</span><h2>Dernières vidéos</h2></div><Link className="btn dark" href="/videos">Voir toutes les vidéos et interviews →</Link></div><YouTubeVideoFeed limit={2}/></section>
