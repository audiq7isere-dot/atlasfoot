...
<header className="top"><div className="wrap nav"><Link className="brand" href="/">ATLAS<b>FOOT</b></Link><nav className="navlinks"><a href="#actus">Actualités</a><Link href="/fil-actualite">⚡ Fil d’actualité</Link><Link href="/mon-xi">Mon XI</Link><Link href="/cafe">☕ Café des Lions</Link></nav><Link className="btn red" href="/cafe">Rejoindre la communauté</Link></div></header>
